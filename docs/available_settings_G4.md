### OLED G4 (2024) firmware v23.21.57, webOS v9.2.2
...
#### part of default DoVi config of >=55" C4 (DMSwVersion = 4.0, IDK_Version = SOC_5.0) (can be used for USB upload)
```ini
[Global]
# Panel Specific
Tmax = 990
...
##### differences in 55"-83" G4/M4 config
```ini
[Global]
# Panel Specific
Tmax = 1350
...
##### differences in 97" G4/M4 config
```ini
[Global]
# Panel Specific
Tmax = 990
...
##### differences in 77" T4 config
```ini
[Global]
# Panel Specific
Tmax = 900
# From panel specification
TPrimaries = 0.6615 0.3328 0.3000 0.6570 0.1504 0.0540 0.3127 0.329

# VSVDB Related Information
vsvdb_Tmax = 900
vsvdb_TPrimaries = 0.6615 0.3328 0.3000 0.6570 0.1504 0.0540 0.3127 0.329
```

##### part of default DoVi config of B4/CS (DMSwVersion = 4.0, IDK_Version = SOC_1.6.1.4)
```ini
[Global]
# Panel Specific
Tmax = 720
