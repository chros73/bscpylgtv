...
##### differences in Z2 config
```ini
[Global]
# Panel Specific
Tmax = 720
TPrimaries = 0.6719 0.3259 0.2643 0.6618 0.1412 0.0554 0.3127 0.329

# VSVDB Related Information
vsvdb_Tmax = 720
vsvdb_TPrimaries = 0.6719 0.3259 0.2643 0.6618 0.1412 0.0554 0.3127 0.329
```
