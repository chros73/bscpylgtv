### OLED C1 (2021) firmware v3.53.45, webOS v6.5.3
...
##### differences in Z1 config
```ini
[Global]
# From panel specification
TPrimaries = 0.6739 0.3257 0.2580 0.6784 0.1441 0.0495 0.3127 0.329

# VSVDB Related Information
vsvdb_Tmin = 0.001
vsvdb_TPrimaries = 0.6739 0.3257 0.2580 0.6784 0.1441 0.0495 0.3127 0.329
```
